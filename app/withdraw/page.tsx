    ...
    <div className="min-h-screen bg-[#0d0e11] text-white flex flex-col font-sans select-none pb-20">
      <div className="w-full max-w-[440px] mx-auto flex-1 flex flex-col">
        ...
        <div
          ...
          className="fixed bottom-16 right-3 sm:absolute sm:bottom-3 sm:right-3 z-20 flex items-center gap-1.5 bg-[#172019] border border-[#22c55e]/40 text-[#22c55e] px-2.5 py-1.5 rounded-full shadow-lg text-[10px] font-bold cursor-pointer hover:bg-[#1f2e23] active:scale-95 transition"
        >
